...
def engineer_features_v3():
    ...
    for df in [train, test]:
        ...
        # Mean lap time grouped by Race and Year
    ...
    train.to_parquet("kaggle_s6e5/data/train_v3.parquet", index=False)
    test.to_parquet("kaggle_s6e5/data/test_v3.parquet", index=False)
    print("V3 features ready! 🥒🚀")
